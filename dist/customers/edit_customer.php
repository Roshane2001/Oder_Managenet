...
<body>
                            ...
                            <div class="form-row">
                                <div class="customer-form-group">
                                    ...
                                    <input type="tel" class="form-control" id="phone" name="phone"
                                        placeholder="0771234567" value="<?= htmlspecialchars($customer['phone']) ?>"
                                        required>
                                ...
                                <div class="customer-form-group">
                                    ...
                                    <input type="tel" class="form-control" id="phone2" name="phone2"
                                        placeholder="0771234567" value="<?= htmlspecialchars($customer['phone2']) ?>">
                            ...
                            <div class="form-row">
                                <div class="customer-form-group">
                                    ...
                                    <input type="hidden" id="city_id" name="city_id"
                                        value="<?= htmlspecialchars($customer['city_id'] ?? '') ?>">
    ...
    function setupRealTimeValidation() {
        ...
        $('#email').on('blur', function() {
            ...
            if (suggestion && suggestion !== $(this).val().toLowerCase()) {
                $('#email-suggestions').html(
                    `Did you mean <a href="#" onclick="$('#email').val('${suggestion}'); $('#email-suggestions').html(''); $('#email').focus();">${suggestion}</a>?`
                    );
            } else {
                $('#email-suggestions').html('');
            }
    ...
    // Validator for phone2 used in edit form: allow empty or validate as phone
    ...
    function validateAddressLine1(address) {
        ...
        if (address.length > 255) {
            return {
                valid: false,
                message: 'Address Line 1 is too long (maximum 255 characters)'
            };
        }
        return {
            valid: true,
